# 1 "source/driver/system/src/clock.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "source/driver/system/src/clock.c" 2
# 34 "source/driver/system/src/clock.c"
...
# 34 "source/driver/system/src/clock.c" 2

# 1 "source/driver/system/src/../clock.h" 1
# 48 "source/driver/system/src/../clock.h"
void CLOCK_Initialize(void);
# 35 "source/driver/system/src/clock.c" 2
