...
# 1 "source/main.c" 2
# 21 "source/main.c"
# 1 "source/./driver/system/system.h" 1
# 37 "source/./driver/system/system.h"
...
# 37 "source/./driver/system/system.h" 2


# 1 "C:\\Program Files\\Microchip\\xc8\\v2.46\\pic\\include\\c99\\stdbool.h" 1 3
# 39 "source/./driver/system/system.h" 2

# 1 "source/./driver/system/config_bits.h" 1
# 37 "source/./driver/system/config_bits.h"
# 1 "source/./driver/system/../system/clock.h" 1
# 48 "source/./driver/system/../system/clock.h"
void CLOCK_Initialize(void);
# 37 "source/./driver/system/config_bits.h" 2
# 40 "source/./driver/system/system.h" 2


# 1 "source/./driver/system/../system/pins.h" 1
# 758 "source/./driver/system/../system/pins.h"
...
# 42 "source/./driver/system/system.h" 2

# 1 "source/./driver/system/../adc/adc.h" 1
# 45 "source/./driver/system/../adc/adc.h"
...
# 79 "source/./driver/system/../adc/adc.h"
void ADC_Initialize(void);
# 88 "source/./driver/system/../adc/adc.h"
...
# 105 "source/./driver/system/../adc/adc.h"
...
# 122 "source/./driver/system/../adc/adc.h"
adc_result_t ADC_GetConversion(adc_channel_t channel);
# 43 "source/./driver/system/system.h" 2

# 1 "source/./driver/system/../timer/tmr0.h" 1
# 38 "source/./driver/system/../timer/tmr0.h"
# 1 "source/./driver/system/../timer/timer_interface.h" 1
# 42 "source/./driver/system/../timer/timer_interface.h"
...
# 42 "source/./driver/system/../timer/timer_interface.h" 2
...
# 38 "source/./driver/system/../timer/tmr0.h" 2
# 47 "source/./driver/system/../timer/tmr0.h"
extern const struct TMR_INTERFACE Timer0;
# 57 "source/./driver/system/../timer/tmr0.h"
void Timer0_Initialize(void);
# 67 "source/./driver/system/../timer/tmr0.h"
void Timer0_Start(void);
# 76 "source/./driver/system/../timer/tmr0.h"
void Timer0_Stop(void);
# 85 "source/./driver/system/../timer/tmr0.h"
uint16_t Timer0_Read(void);
# 94 "source/./driver/system/../timer/tmr0.h"
void Timer0_Write(size_t timerVal);
# 103 "source/./driver/system/../timer/tmr0.h"
void Timer0_Reload(void);
# 112 "source/./driver/system/../timer/tmr0.h"
...
# 44 "source/./driver/system/system.h" 2

# 1 "source/./driver/system/../timer/delay.h" 1
# 44 "source/./driver/system/../timer/delay.h"
...
# 45 "source/./driver/system/system.h" 2

# 1 "source/./driver/system/../system/watchdog.h" 1
# 52 "source/./driver/system/../system/watchdog.h"
void WDT_Initialize(void);
# 46 "source/./driver/system/system.h" 2

# 1 "source/./driver/system/../system/interrupt.h" 1
# 85 "source/./driver/system/../system/interrupt.h"
void INTERRUPT_Initialize (void);
# 219 "source/./driver/system/../system/interrupt.h"
void INT0_ISR(void);
# 228 "source/./driver/system/../system/interrupt.h"
void INT0_CallBack(void);
# 237 "source/./driver/system/../system/interrupt.h"
void INT0_SetInterruptHandler(void (* InterruptHandler)(void));
# 246 "source/./driver/system/../system/interrupt.h"
extern void (*INT0_InterruptHandler)(void);
# 255 "source/./driver/system/../system/interrupt.h"
void INT0_DefaultInterruptHandler(void);
# 264 "source/./driver/system/../system/interrupt.h"
void INT1_ISR(void);
# 273 "source/./driver/system/../system/interrupt.h"
void INT1_CallBack(void);
# 282 "source/./driver/system/../system/interrupt.h"
void INT1_SetInterruptHandler(void (* InterruptHandler)(void));
# 291 "source/./driver/system/../system/interrupt.h"
extern void (*INT1_InterruptHandler)(void);
# 300 "source/./driver/system/../system/interrupt.h"
void INT1_DefaultInterruptHandler(void);
# 309 "source/./driver/system/../system/interrupt.h"
void INT2_ISR(void);
# 318 "source/./driver/system/../system/interrupt.h"
void INT2_CallBack(void);
# 327 "source/./driver/system/../system/interrupt.h"
void INT2_SetInterruptHandler(void (* InterruptHandler)(void));
# 336 "source/./driver/system/../system/interrupt.h"
extern void (*INT2_InterruptHandler)(void);
# 345 "source/./driver/system/../system/interrupt.h"
void INT2_DefaultInterruptHandler(void);
# 47 "source/./driver/system/system.h" 2
# 56 "source/./driver/system/system.h"
void SYSTEM_Initialize(void);
# 21 "source/main.c" 2



# 1 "source/remoteButton.h" 1
# 15 "source/remoteButton.h"
 typedef enum
 {
  REMOTE_BUTTON_UP = 0,
  REMOTE_BUTTON_DOWN,
...
_Bool detectSunRise(void);
_Bool detectSunSet(void);




volatile _Bool bIsMainLoopTimingIsOver = 0;
...
int main(void)
{
    ...
    while(1)
    {
        ...
        while ( bIsMainLoopTimingIsOver == 1 )
        {
            bIsMainLoopTimingIsOver = 0;
            __asm(" clrwdt");
            ...
            if ( detectSunRise() == 1 )
            {
                RBT_simulateButtonPush(REMOTE_BUTTON_UP,3,500);
            }
            else if( detectSunSet() == 1 )
            {
                RBT_simulateButtonPush(REMOTE_BUTTON_DOWN,3,500);
            }
            else
            {
...
_Bool detectSunRise(void)
{
 ...
 if ( i16uLuminosityAdc > 1023 )
 {

  if ( i16uCntLuminosityHigh < (5*60000/10) )
  {
...
_Bool detectSunSet(void)
{
  ...
  if ( i16uLuminosityAdc < 0 )
 {

  if ( i16uCntLuminosityLow < (5*60000/10) )
  {
